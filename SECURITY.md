Here is a suggested **`SECURITY.md`** file for **GLITCHLAB**. It addresses the specific security considerations for an agentic development engine, such as prompt injection and autonomous tool execution.
