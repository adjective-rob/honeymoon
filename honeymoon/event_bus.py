...
class EventBus:
    """A lightweight, synchronous event bus for decoupling Honeymoon observability."""
    
    def __init__(self):
        self._subscribers: List[Callable[[HiveEvent], None]] = []

    def subscribe(self, callback: Callable[[HiveEvent], None]) -> None:
    ...
    def emit(
        ...
        """Construct and broadcast a HiveEvent to all subscribers."""
        event = HiveEvent(
