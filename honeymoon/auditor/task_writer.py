"""
HONEYMOON Auditor — Task Writer

Takes structured findings from the scanner and generates
well-scoped HONEYMOON task YAML files using an Agentic Loop.
...
from honeymoon.controller import Task  # Import the strict Pydantic schema
...
AUDITOR_TOOLS = [
    ...
    },
    {
        ...
        "function": {
            "name": "create_task",
            "description": "Create and save a new HONEYMOON task YAML.",
            "parameters": {
                "type": "object",
                "properties": {
...
class TaskWriter:
    """
    Generates HONEYMOON task YAML files from scanner findings and ideation.
    ...
    def _read_roadmap(self, repo_path: Path) -> str:
        """Read .honeymoon/ROADMAP.md for task prioritization context."""
        roadmap = repo_path / ".honeymoon" / "ROADMAP.md"
    ...
    def write_tasks(self, result: ScanResult) -> list[Path]:
        ...
        system_prompt = """You are the HONEYMOON Auditor & Ideation Agent.
...
- honeymoon/controller.py
- honeymoon/config_loader.py
- honeymoon/router.py
- honeymoon/agents/__init__.py
- honeymoon/workspace/__init__.py
- honeymoon/workspace/tools.py
- honeymoon/event_bus.py
- honeymoon/governance/__init__.py
- config.yaml
