"""
HONEYMOON Controller — The Brainstem (v3)
...
from honeymoon.agents import AgentResult, BaseAgent
from honeymoon.agent_runners import (
    run_archivist,
    run_fix_loop,
    run_implementer,
    run_planner,
...
from honeymoon.controller_utils import pre_task_git_fetch
from honeymoon.event_bus import bus
from honeymoon.governance import BoundaryEnforcer
from honeymoon.history import TaskHistory
from honeymoon.lifecycle import (
    check_repo_clean,
    finalize,
    post_run,
    print_banner,
...
from honeymoon.step_handlers import (
    STEP_HANDLERS,
    HandlerSignal,
    PipelineState,
)
from honeymoon.task import Task
from honeymoon.task_state import TaskState, StepState  # re-export  # noqa: F401
...
class Controller:
    ...
    def __init__(
        self,
        repo_path: Path,
        config: HoneymoonConfig | None = None,
    ...
    def run(self, task: Task) -> dict[str, Any]:
        ...
        from honeymoon.task_quality import get_quality_constraints
