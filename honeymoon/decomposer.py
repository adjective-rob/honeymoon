"""
HONEYMOON Task Decomposer — Splits tasks into non-overlapping sub-tasks.
...
from honeymoon.swarm import SubTask
...
DECOMPOSER_SYSTEM_PROMPT = """You are the HONEYMOON Task Decomposer.
...
class TaskDecomposer:
    ...
    def __init__(self, router: Router, config: HoneymoonConfig):
        self.router = router
        self.config = config
