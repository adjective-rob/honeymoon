"""
HONEYMOON Task History — Append-Only Run Log

Every HONEYMOON run is recorded in .honeymoon/logs/history.json.
This provides:
...
class TaskHistory:
    ...
    Storage: .honeymoon/logs/history.jsonl (one JSON object per line)
    """

    def __init__(self, repo_path: Path):
        self.repo_path = repo_path.resolve()
        self.log_dir = self.repo_path / ".honeymoon" / "logs"
