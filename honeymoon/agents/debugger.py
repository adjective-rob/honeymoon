"""
🩺 The Nurse — Debugger (v3.0 Tool-Loop Architecture)

Operates in an agentic loop. Features a 'think' tool for root-cause
analysis, search_grep for exploration, and get_error for verification.
Tends to sick cells and heals the hive.
"""
...
from honeymoon.context_compressor import compress_stale_messages, hard_compact_messages
