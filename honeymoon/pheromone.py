"""
HONEYMOON Pheromone Trail — Shared Swarm Awareness Layer
...
Events are stored in .honeymoon/pheromones.jsonl (one JSON object per line).
...
from honeymoon.event_bus import HiveEvent, bus
...
class PheromoneTrail:
    ...
    Also acts as an EventBus subscriber, converting relevant HiveEvents
    into pheromone records automatically.
    """

    def __init__(self, repo_path: Path, run_id: str, subscribe: bool = True):
        self.trail_path = repo_path / ".honeymoon" / "pheromones.jsonl"
        self.run_id = run_id
