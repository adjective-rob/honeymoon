"""
HONEYMOON Step Handlers — Per-agent post-processing logic.
...
from honeymoon.display import print_security_issues
from honeymoon.doc_inserter import insert_doc_comments, write_adr
from honeymoon.events import emit_event
from honeymoon.governance import BoundaryViolation
from honeymoon.run_context import RunContext
from honeymoon.task import Task, apply_changes, apply_tests
from honeymoon.task_state import StepState
...
def handle_implementer_result(
    ...
    if patch_failures:
        ...
        from honeymoon.agent_runners import retry_patch
